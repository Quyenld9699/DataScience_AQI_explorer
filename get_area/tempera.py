...
xp = '//*[@id="rso"]/div[1]/div/div/div/div/div[1]/div/div/div/div[2]/div[1]/div/g-expandable-container/div/div[1]/g-expandable-content[1]/span/div[2]/div[2]/span/div/span[1]'
...
new_temp = dict()
new_temp['city'], new_temp['Nov'], new_temp['Dec'], new_temp['Jan'] = list(), list(), list(), list()
...
for index, c in enumerate(csv_data['Name']):
    ...
    area, unit, url = crawl(driver, c, attr)
    if attr == "area":
